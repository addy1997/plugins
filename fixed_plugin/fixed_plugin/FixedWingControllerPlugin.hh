...
#ifndef IGNITION_GAZEBO_SYSTEMS_FIXEDWINGCONTROLLER_PLUGIN_HH_
#define IGNITION_GAZEBO_SYSTEMS_FIXEDWINGCONTROLLER_PLUGIN_HH_
...
{  
   // Forward declaration
   class FixedWingControllerPluginPrivate;
    
   /// \brief Allow moving the control surfaces of a FixedWingController C-172 plane. This
   ...
   {   
      ...
      private: std::unique_ptr<FixedWingControllerPluginPrivate> dataPtr;
   };
   }
}
}
